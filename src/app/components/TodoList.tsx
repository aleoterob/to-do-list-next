...
const TodoList: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-px600 mx-auto justify-center items-center bg-transparent overflow-x-hidden   border rounded-xl border-gray-500/45 overflow-y-auto h-full">
